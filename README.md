...
Общение с картами осуществляется через считыватель **RC522**, который обеспечивает надежное распознавание карт-пропусков.

### Конструктивные элементы

**Схема детектирующего устройства**  
*Механизм контроля наличия ключей*
...
- 🔄 **Взаимодействие с RC522** - работа со считывателем карт
- ⌨️ **Обработка команд** с консоли управления
- 👥 **Управление пользователями** система доступа
- 💾 **Структура хранения данных** - организация информации
- 📊 **Обмен данными JSON** - тестовые отправки и прием
- 💾 **Сохранение данных** в постоянной памяти ESP32
...
*Проект находится в активной разработке. Присоединяйтесь к обсуждению!*
